...
void TicTacToe::winning_position (char playerorai, int &row, int &col)
{
	...
	int i, j, char_count, emptyrow, emptycol, char_countv;
...
void TicTacToe::ai_move () {	
	...
	// 		return;
	// 	}
	// 	else if (pre_counter_xv == 2 && pre_counter_blankv == 3) {
	// 		board[a][b] = ai_char;
	// 		return;
	// 	}
	// 	else if (pre_counter_xv == 1 && pre_counter_blankv == 4) {
	// 		board[a][b] = ai_char;
	// 		return;
	// 	}
	// 	counter_xv=0;
